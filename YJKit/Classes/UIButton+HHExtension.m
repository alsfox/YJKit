...
- (void)yj_setWebImageWIthURLStr:(NSString *)urlStr placeholder:(NSString *)imageName {
    [self yj_setWebImageWIthURLStr:urlStr forState:UIControlStateNormal placeholder:imageName];
}
